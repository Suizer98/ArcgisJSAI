...
export const webSearchTool = tool({
  description:
    'Search for any type of business, service, or place near a location. Can find restaurants, gas stations, hotels, shops, hospitals, schools, etc.',
  inputSchema: z.object({
    query: z
      .string()
      .describe('What to search for - can be any type of business or service'),
    location: z
      .object({
      ...
      .optional()
      .describe(
        'Optional location to search near - if not provided, will search generally'
      ),
  }),
